class Aventura {
  ...
  mostrar() {
    ...
    switch (this.estado) {  //PASADOOR DE ESTADOS
    case 0:
    ...
    case 1:
      ...
      break;
    case 2:
      this.pantalla.mostrar(2, 320, 10, 200, 75, 320, 85, 200, 71);
      this.boton1.mostrar(380, 530, 200, 50, "Continuar");
      break;
    case 3:
      this.pantalla.mostrar(3, 0, 300, 300, 55, 700, 700, 300, 50);
      this.boton1.mostrar(25, 450, 200, 100, "Tomar una decision clave");
      this.boton2.mostrar(360, 450, 200, 100, "Seguir con su vida corriente");
      break;
    case 4:
    ...
    case 7:
      ...
      break;
    case 8:
      this.pantalla.mostrar(8, 10, 10, 200, 80, 10, 90, 200, 80);
      this.boton1.mostrar(380, 530, 200, 50, "Continuar");
      break;
    case 9:
    ...
    case 12:  //TIMER PARA PASAR DE PANTALLA
      this.pantalla.mostrar(12, 250, 250, 100, 100, 200, 350, 200, 100);
      this.timer++;
      if (this.timer >= 300) {
        this.estado = 13;
    ...
    case 15:
      ...
      this.boton1.mostrar(25, 450, 200, 100, "Conocer Marte");
      this.boton2.mostrar(360, 450, 200, 100, "Viajar a la Luna");
      break;
    case 16:
